...
<critical>You MUST have already loaded and processed: {project_root}/.ceiba-metodo/core/workflows/brainstorming/workflow.yaml</critical>
...
<invoke-task halt="true">{project-root}/.ceiba-metodo/core/tasks/advanced-elicitation.xml</invoke-task>
