...
helpers: '{project-root}/.ceiba-metodo/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/.ceiba-metodo/core/resources/excalidraw/validate-json-instructions.md'
```
